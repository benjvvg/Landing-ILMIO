        ...
        <nav className='fixed top-0 left-0 w-full z-50 bg-gray-900/60 backdrop-blur-xl border-b border-white/10 shadow-lg shadow-violet-900/20 transition-all duration-300'>
            <div className='max-w-7xl mx-auto px-6 sm:px-8'>
                ...
                <div className='flex md:grid md:grid-cols-3 items-center justify-between h-20'>
                    ...
                    <div className='flex shrink-0 items-center md:justify-self-start md:pl-32'>
                    ...
                    <div className='hidden md:flex justify-center md:justify-self-center'>
            ...
            {isOpen && (
                <div className='absolute top-full left-0 mt-2 w-full bg-gray-900/95 backdrop-blur-xl border-t border-white/10 shadow-2xl p-4 flex flex-col space-y-2 md:hidden animate-in fade-in slide-in-from-top-5'>
                    {['Inicio', 'Servicios', 'Evolución', 'Operación', 'Contacto'].map((item) => (
                        <a 
                            key={item}
                            href={`#${item.toLowerCase()}`}
